...
public class UserC {
    ...
    public void loginUser(String username, char[] password, boolean isAdmin) throws IOException {
        try {
            ...
            // Crea un objecte UserM amb les dades d'usuari
            UserM log = new UserM(username, passwordString);
            ObjectMapper objM1 = new ObjectMapper();
            String requestBodyLogin = objM1.writeValueAsString(log);
